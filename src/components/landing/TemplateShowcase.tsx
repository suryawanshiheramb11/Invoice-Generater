...
const templates: { id: TemplateId; name: string; description: string; accent: string }[] = [
  ...
  { id: "modern", name: "Modern", description: "Clean contemporary design", accent: "#4f46e5" },
    ...
    <div className="mt-14 grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-5">
      {templates.map((t) => (
        <Link
          ...
          className="group rounded-xl border border-border bg-surface p-3 transition-shadow hover:shadow-md"
        >
          <div className="aspect-[3/4] w-full overflow-hidden rounded-lg border border-border bg-white p-3">
